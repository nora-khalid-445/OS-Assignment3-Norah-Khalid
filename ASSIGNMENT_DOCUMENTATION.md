...
**Video Link**: [https://drive.google.com/file/d/1tNmpuOca75cwCawQVdjc81m_55K7vPzs/view?usp=drivesdk]

**Video filename**: `445052045_Assignment3_Synchronization.mp4`

**Verification**:
- [done ] Link is accessible (tested in incognito mode)
- [ done] Video is 3-5 minutes long
- [done ] Video shows code walkthrough and commits
- [ done] Video has clear audio
- [ done] Uploaded to PERSONAL Gmail (not @std.psau.edu.sa)
